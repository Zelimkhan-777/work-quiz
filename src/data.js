...
import Vue from "../icons/vuedotjs.svg";
...
const rawData = [
  ...
  },
  {
    ...
    difficulty: "hard",
    question:
      "Какой тег лучше использовать для основной уникальной области страницы?",
  ...
  },
  {
    ...
    difficulty: "hard",
    question:
      'Почему не стоит ставить positive tabindex, например tabindex="5"?',
    options: [
  ...
  },
  {
    ...
    difficulty: "hard",
    question:
      'Что произойдет, если внутри <dialog> отправить форму с method="dialog"?',
    options: [
  ...
  },
  {
    ...
    options: ["Фреймворк для создания веб-приложений", "Библиотека для работы только с CSS", "СУБД", "Сборщик модулей"],
    correctAnswerIndex: 0,
    explanation: "Angular - полноценный frontend-фреймворк для создания клиентских приложений.",
  },
  {
    id: 282,
    category: "Angular",
    difficulty: "easy",
    question: "Какой язык чаще всего используется в Angular?",
    options: ["TypeScript", "PHP", "Ruby", "Go"],
    correctAnswerIndex: 0,
    explanation: "Angular изначально ориентирован на TypeScript и активно использует его типизацию и декораторы.",
  },
  {
    id: 283,
    category: "Angular",
    difficulty: "easy",
    question: "Что описывает компонент Angular?",
    options: ["Часть интерфейса с шаблоном, стилями и логикой", "Только CSS-файл", "Только HTTP-запрос", "Только роут"],
    correctAnswerIndex: 0,
    explanation: "Компонент объединяет представление и поведение отдельной части UI.",
  },
  {
    id: 284,
    category: "Angular",
    difficulty: "easy",
    question: "Какой декоратор объявляет Angular-компонент?",
    options: ["@Component", "@Injectable", "@Module", "@Route"],
    correctAnswerIndex: 0,
    explanation: "@Component сообщает Angular метаданные компонента: selector, template, styles и другие настройки.",
  },
  {
    id: 285,
    category: "Angular",
    ...
    options: ["Условно добавляет или удаляет элемент из DOM", "Повторяет элемент по массиву", "Создает сервис", "Меняет URL"],
    correctAnswerIndex: 0,
    explanation: "*ngIf отображает часть шаблона только при истинном условии.",
  },
  {
    id: 286,
    category: "Angular",
    ...
    options: ["Повторяет шаблон для элементов коллекции", "Проверяет форму", "Создает компонент", "Останавливает событие"],
    correctAnswerIndex: 0,
    explanation: "*ngFor используется для вывода списков на основе массивов или других коллекций.",
  },
  {
    id: 287,
    category: "Angular",
    difficulty: "easy",
    question: "Как обозначается привязка события click в шаблоне Angular?",
    options: ["(click)", "[click]", "{{ click }}", "*click"],
    correctAnswerIndex: 0,
    explanation: "Круглые скобки используются для event binding, например (click)=\"save()\".",
  },
  {
    id: 288,
    category: "Angular",
    difficulty: "easy",
    question: "Как обозначается привязка свойства в Angular?",
    options: ["[property]", "(property)", "{{ property() }}", "#property"],
    correctAnswerIndex: 0,
    explanation: "Квадратные скобки используются для property binding, например [disabled]=\"isLoading\".",
  },
  {
    id: 289,
    category: "Angular",
    difficulty: "easy",
    question: "Для чего нужен Angular CLI?",
    options: ["Для генерации, сборки и запуска Angular-проекта", "Для замены браузера", "Для написания CSS без файлов", "Для хранения данных"],
    correctAnswerIndex: 0,
    explanation: "Angular CLI помогает создавать проект, компоненты, сервисы, запускать dev-server и сборку.",
  },
  {
    id: 290,
    category: "Angular",
    ...
    options: ["Класс для общей логики и данных, внедряемый через DI", "HTML-шаблон", "CSS-модуль", "Только роутер"],
    correctAnswerIndex: 0,
    explanation: "Сервисы выносят общую бизнес-логику и могут внедряться в компоненты через dependency injection.",
  },
  {
    id: 291,
    category: "Angular",
    difficulty: "medium",
    question: "Что делает декоратор @Injectable?",
    options: ["Позволяет классу участвовать в dependency injection", "Создает HTML-тег", "Запускает тесты", "Описывает CSS"],
    correctAnswerIndex: 0,
    explanation: "@Injectable помечает класс как доступный для системы внедрения зависимостей Angular.",
  },
  {
    id: 292,
    category: "Angular",
    difficulty: "medium",
    question: "Для чего используется HttpClient?",
    options: ["Для выполнения HTTP-запросов", "Для рендера шаблонов", "Для роутинга", "Для компиляции TypeScript"],
    correctAnswerIndex: 0,
    explanation: "HttpClient предоставляет методы get, post, put, delete и возвращает Observable.",
  },
  {
    id: 293,
    category: "Angular",
    difficulty: "medium",
    question: "Что такое Observable в Angular-приложениях?",
    options: ["Поток значений во времени", "Обычная строка", "CSS-селектор", "HTML-атрибут"],
    correctAnswerIndex: 0,
    explanation: "Observable из RxJS часто используется для асинхронных данных, событий и HTTP-ответов.",
  },
  {
    id: 294,
    category: "Angular",
    difficulty: "medium",
    question: "Для чего нужен async pipe?",
    options: ["Чтобы подписываться на Observable/Promise в шаблоне и очищать подписку", "Чтобы сделать функцию асинхронной", "Чтобы подключить скрипт async", "Чтобы ускорить CSS"],
    correctAnswerIndex: 0,
    explanation: "async pipe управляет подпиской автоматически и помогает избежать ручного unsubscribe.",
  },
  {
    id: 295,
    category: "Angular",
    difficulty: "medium",
    question: "Что делает RouterModule?",
    options: ["Настраивает маршрутизацию между страницами/компонентами", "Создает формы", "Проверяет типы", "Меняет тему приложения"],
    correctAnswerIndex: 0,
    explanation: "RouterModule связывает URL-маршруты с компонентами и управляет навигацией.",
  },
  {
    id: 296,
    category: "Angular",
    ...
    options: ["Для передачи данных от родителя в дочерний компонент", "Для отправки события наверх", "Для создания сервиса", "Для настройки роутера"],
    correctAnswerIndex: 0,
    explanation: "@Input объявляет входное свойство компонента.",
  },
  {
    id: 297,
    category: "Angular",
    difficulty: "medium",
    question: "Для чего используется @Output?",
    options: ["Для передачи события из дочернего компонента родителю", "Для чтения URL", "Для подключения CSS", "Для создания pipe"],
    correctAnswerIndex: 0,
    explanation: "@Output обычно работает вместе с EventEmitter и сообщает родителю о действиях дочернего компонента.",
  },
  {
    id: 298,
    category: "Angular",
    difficulty: "medium",
    question: "Что такое reactive forms?",
    options: ["Подход к формам, где состояние описывается в TypeScript-коде", "Формы только на HTML", "CSS-анимации формы", "Автоматическая отправка формы"],
    correctAnswerIndex: 0,
    explanation: "Reactive forms строятся через FormControl, FormGroup и валидаторы в коде компонента.",
  },
  {
    id: 299,
    category: "Angular",
    difficulty: "medium",
    question: "Что делает ngClass?",
    options: ["Динамически добавляет CSS-классы", "Создает новый компонент", "Перезапускает приложение", "Описывает HTTP-запрос"],
    correctAnswerIndex: 0,
    explanation: "ngClass удобно использовать, когда классы зависят от состояния компонента.",
  },
  {
    id: 300,
    category: "Angular",
    ...
    options: ["Функция преобразования значения для отображения в шаблоне", "Маршрут приложения", "Тип сервиса", "CSS-директива"],
    correctAnswerIndex: 0,
    explanation: "Pipes форматируют данные в шаблонах, например дату, валюту или пользовательские значения.",
  },
  {
    id: 301,
    category: "Angular",
    difficulty: "hard",
    question: "Что дает ChangeDetectionStrategy.OnPush?",
    options: ["Ограничивает проверки компонента изменениями input, событиями и явными сигналами", "Отключает TypeScript", "Запрещает Observable", "Удаляет компонент из DOM"],
    correctAnswerIndex: 0,
    explanation: "OnPush помогает уменьшить количество проверок change detection и улучшить производительность.",
  },
  {
    id: 302,
    category: "Angular",
    difficulty: "hard",
    question: "Для чего нужен trackBy в *ngFor?",
    options: ["Чтобы Angular стабильнее сопоставлял элементы списка и меньше перерисовывал DOM", "Чтобы сортировать массив", "Чтобы фильтровать список", "Чтобы создать роут"],
    correctAnswerIndex: 0,
    explanation: "trackBy возвращает уникальный идентификатор элемента и помогает Angular переиспользовать DOM-узлы.",
  },
  {
    id: 303,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое lazy loading маршрутов?",
    options: ["Загрузка части приложения только при переходе на нужный маршрут", "Медленная загрузка всех скриптов", "Отключение роутера", "Предзагрузка изображений"],
    correctAnswerIndex: 0,
    explanation: "Lazy loading уменьшает начальный bundle, откладывая загрузку функциональных областей.",
  },
  {
    id: 304,
    category: "Angular",
    difficulty: "hard",
    question: "Что делает Route Guard?",
    options: ["Контролирует доступ или уход с маршрута", "Создает CSS-переменные", "Кэширует картинки", "Собирает проект"],
    correctAnswerIndex: 0,
    explanation: "Guards позволяют проверять условия навигации: авторизацию, несохраненные изменения и другие правила.",
  },
  {
    id: 305,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое resolver в Angular Router?",
    options: ["Механизм предварительной загрузки данных перед активацией маршрута", "CSS-функция", "Способ создания pipe", "Тип компонента"],
    correctAnswerIndex: 0,
    explanation: "Resolver получает данные до отображения компонента маршрута.",
  },
  {
    id: 306,
    category: "Angular",
    difficulty: "hard",
    question: "Для чего используется takeUntilDestroyed?",
    options: ["Для автоматического завершения подписок при уничтожении компонента", "Для создания формы", "Для смены URL", "Для оптимизации SVG"],
    correctAnswerIndex: 0,
    explanation: "takeUntilDestroyed помогает безопасно очищать RxJS-подписки без ручного Subject.",
  },
  {
    id: 307,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое standalone component?",
    options: ["Компонент, который можно использовать без объявления в NgModule", "Компонент без шаблона", "Компонент только для тестов", "Компонент без зависимостей"],
    correctAnswerIndex: 0,
    explanation: "Standalone components упрощают структуру Angular-приложения и позволяют импортировать зависимости прямо в компонент.",
  },
  {
    id: 308,
    category: "Angular",
    difficulty: "hard",
    question: "Для чего нужны signals в Angular?",
    options: ["Для реактивного хранения значений и точного отслеживания зависимостей", "Для отправки HTTP-заголовков", "Для создания CSS-сигналов", "Для генерации маршрутов"],
    correctAnswerIndex: 0,
    explanation: "Signals дают более явную реактивную модель состояния и могут уменьшать лишние проверки.",
  },
  {
    id: 309,
    category: "Angular",
    difficulty: "hard",
    question: "Что делает NgZone?",
    options: ["Помогает Angular узнавать, когда нужно запускать change detection после async-операций", "Создает область CSS", "Разделяет роуты", "Хранит env-переменные"],
    correctAnswerIndex: 0,
    explanation: "NgZone связан с отслеживанием асинхронных задач и запуском обновления представления.",
  },
  {
    id: 310,
    category: "Angular",
    difficulty: "hard",
    question: "Когда полезен providedIn: 'root' у сервиса?",
    options: ["Когда нужен singleton-сервис на уровне всего приложения с tree-shaking", "Когда сервис нужен только в одном методе", "Когда сервис должен стать компонентом", "Когда нужно отключить DI"],
    correctAnswerIndex: 0,
    explanation: "providedIn: 'root' регистрирует сервис в корневом injector и позволяет не добавлять его вручную в providers.",
  },
  {
    id: 311,
    category: "Vue",
    ...
    options: ["JavaScript-фреймворк для создания пользовательских интерфейсов", "CSS-препроцессор", "Серверная ОС", "СУБД"],
    correctAnswerIndex: 0,
    explanation: "Vue используется для создания реактивных интерфейсов и frontend-приложений.",
  },
  {
    id: 312,
    category: "Vue",
    difficulty: "easy",
    question: "Какой файл часто содержит Vue single-file component?",
    options: [".vue", ".sql", ".env", ".lock"],
    correctAnswerIndex: 0,
    explanation: "Файл .vue обычно объединяет template, script и style одного компонента.",
  },
  {
    id: 313,
    category: "Vue",
    difficulty: "easy",
    question: "Для чего используется директива v-if?",
    options: ["Для условного рендера элемента", "Для перебора массива", "Для отправки формы", "Для подключения роутера"],
    correctAnswerIndex: 0,
    explanation: "v-if добавляет элемент в DOM только когда условие истинно.",
  },
  {
    id: 314,
    category: "Vue",
    difficulty: "easy",
    question: "Для чего используется директива v-for?",
    options: ["Для вывода списка по массиву", "Для условного CSS", "Для создания store", "Для подключения изображения"],
    correctAnswerIndex: 0,
    explanation: "v-for повторяет блок шаблона для каждого элемента коллекции.",
  },
  {
    id: 315,
    category: "Vue",
    difficulty: "easy",
    question: "Как во Vue записывается обработчик клика?",
    options: ["@click", ":click", "#click", "*click"],
    correctAnswerIndex: 0,
    explanation: "@click - сокращение для v-on:click.",
  },
  {
    id: 316,
    category: "Vue",
    difficulty: "easy",
    question: "Как во Vue записывается привязка атрибута?",
    options: [":href", "@href", "#href", "*href"],
    correctAnswerIndex: 0,
    explanation: "Двоеточие - сокращение для v-bind, например :href=\"url\".",
  },
  {
    id: 317,
    category: "Vue",
    ...
    options: ["Создает двустороннюю привязку значения формы", "Создает новый компонент", "Удаляет элемент", "Запускает роутер"],
    correctAnswerIndex: 0,
    explanation: "v-model связывает значение input/select/textarea с состоянием компонента.",
  },
  {
    id: 318,
    category: "Vue",
    ...
    options: ["Данные, передаваемые от родителя дочернему компоненту", "Глобальные CSS-классы", "HTTP-запросы", "Маршруты"],
    correctAnswerIndex: 0,
    explanation: "Props позволяют компоненту получать входные данные от родителя.",
  },
  {
    id: 319,
    category: "Vue",
    difficulty: "easy",
    question: "Для чего используется emit во Vue?",
    options: ["Чтобы дочерний компонент отправил событие родителю", "Чтобы импортировать CSS", "Чтобы создать computed", "Чтобы удалить prop"],
    correctAnswerIndex: 0,
    explanation: "emit сообщает родителю о событии или передает данные наверх.",
  },
  {
    id: 320,
    category: "Vue",
    difficulty: "easy",
    question: "Что обычно делает createApp?",
    options: ["Создает экземпляр Vue-приложения", "Создает базу данных", "Компилирует Sass", "Запускает сервер Node"],
    correctAnswerIndex: 0,
    explanation: "createApp инициализирует Vue-приложение, которое затем монтируется через mount.",
  },
  {
    id: 321,
    category: "Vue",
    ...
    options: ["Подход к организации логики через setup, ref, reactive и composables", "Набор CSS-миксинов", "Система сборки", "Только router API"],
    correctAnswerIndex: 0,
    explanation: "Composition API помогает группировать связанную логику и переиспользовать ее между компонентами.",
  },
  {
    id: 322,
    category: "Vue",
    ...
    options: ["ref хранит значение в .value, reactive создает реактивный объект", "ref работает только с CSS", "reactive работает только с числами", "Они полностью одинаковы"],
    correctAnswerIndex: 0,
    explanation: "ref удобен для примитивов и отдельных значений, reactive - для объектов состояния.",
  },
  {
    id: 323,
    category: "Vue",
    difficulty: "medium",
    question: "Для чего используется computed?",
    options: ["Для кэшируемого значения, зависящего от реактивных данных", "Для прямого изменения DOM", "Для загрузки роутов", "Для объявления props"],
    correctAnswerIndex: 0,
    explanation: "computed пересчитывается только когда меняются его зависимости.",
  },
  {
    id: 324,
    category: "Vue",
    difficulty: "medium",
    question: "Когда стоит использовать watch?",
    options: ["Когда нужно выполнить побочный эффект при изменении реактивного значения", "Когда нужно вывести список", "Когда нужен CSS-класс", "Когда нужно создать app"],
    correctAnswerIndex: 0,
    explanation: "watch следит за источником данных и запускает callback при изменении.",
  },
  {
    id: 325,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает Vue Router?",
    options: ["Управляет навигацией между страницами/представлениями", "Создает CSS", "Хранит npm-зависимости", "Компилирует HTML"],
    correctAnswerIndex: 0,
    explanation: "Vue Router связывает URL с компонентами и позволяет строить SPA-навигацию.",
  },
  {
    id: 326,
    category: "Vue",
    ...
    options: ["Библиотека управления состоянием для Vue", "UI-кит", "Тестовый раннер", "Сборщик"],
    correctAnswerIndex: 0,
    explanation: "Pinia используется как современное хранилище состояния во Vue-приложениях.",
  },
  {
    id: 327,
    category: "Vue",
    difficulty: "medium",
    question: "Для чего нужен slot?",
    options: ["Чтобы родитель мог передать разметку внутрь компонента", "Чтобы создать HTTP-запрос", "Чтобы объявить роут", "Чтобы удалить prop"],
    correctAnswerIndex: 0,
    explanation: "Slots делают компоненты гибкими, позволяя вставлять пользовательское содержимое.",
  },
  {
    id: 328,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает scoped у <style scoped>?",
    options: ["Ограничивает стили текущим компонентом", "Делает стили глобальными", "Удаляет CSS при сборке", "Подключает Tailwind"],
    correctAnswerIndex: 0,
    explanation: "scoped добавляет атрибуты, благодаря которым CSS применяется только к элементам компонента.",
  },
  {
    id: 329,
    category: "Vue",
    difficulty: "medium",
    question: "Для чего используется provide/inject?",
    options: ["Для передачи зависимостей глубоко вложенным компонентам без prop drilling", "Для подключения SVG", "Для запуска dev-server", "Для создания computed"],
    correctAnswerIndex: 0,
    explanation: "provide/inject помогает передавать данные через дерево компонентов без промежуточных props.",
  },
  {
    id: 330,
    category: "Vue",
    difficulty: "medium",
    question: "Что такое template ref?",
    options: ["Ссылка на DOM-элемент или компонент из шаблона", "Файл шаблона", "CSS-селектор", "Тип роутера"],
    correctAnswerIndex: 0,
    explanation: "Template refs позволяют обратиться к элементу или дочернему компоненту после рендера.",
  },
  {
    id: 331,
    category: "Vue",
    difficulty: "hard",
    question: "Зачем указывать key в v-for?",
    options: ["Чтобы Vue корректно сопоставлял элементы при обновлениях списка", "Чтобы отсортировать массив", "Чтобы скрыть элемент", "Чтобы создать роут"],
    correctAnswerIndex: 0,
    explanation: "Стабильный key помогает Vue переиспользовать и перемещать DOM-узлы без ошибок состояния.",
  },
  {
    id: 332,
    category: "Vue",
    ...
    options: ["Объявляет props компонента", "Создает store", "Подключает router", "Запускает watcher"],
    correctAnswerIndex: 0,
    explanation: "defineProps - compile-time макрос для объявления входных свойств в script setup.",
  },
  {
    id: 333,
    category: "Vue",
    difficulty: "hard",
    question: "Что делает defineEmits в <script setup>?",
    options: ["Объявляет события, которые компонент может отправлять", "Объявляет CSS-классы", "Создает computed", "Настраивает сборку"],
    correctAnswerIndex: 0,
    explanation: "defineEmits описывает emit-события компонента и помогает типизировать их.",
  },
  {
    id: 334,
    category: "Vue",
    difficulty: "hard",
    question: "Для чего используется shallowRef?",
    options: ["Для реактивности только на уровне .value без глубокого отслеживания объекта", "Для глубокого клонирования", "Для создания router-link", "Для автоматической валидации"],
    correctAnswerIndex: 0,
    explanation: "shallowRef полезен для больших объектов или внешних инстансов, где глубокая реактивность не нужна.",
  },
  {
    id: 335,
    category: "Vue",
    ...
    options: ["Функция, которая инкапсулирует и переиспользует реактивную логику", "CSS-файл", "Тип слота", "Маршрут"],
    correctAnswerIndex: 0,
    explanation: "Composables обычно начинаются с use и позволяют выносить общую Composition API-логику.",
  },
  {
    id: 336,
    category: "Vue",
    difficulty: "hard",
    question: "Что делает Suspense во Vue?",
    options: ["Позволяет показывать fallback, пока асинхронные зависимости компонента не готовы", "Создает transition", "Отключает reactivity", "Меняет URL"],
    correctAnswerIndex: 0,
    explanation: "Suspense помогает обрабатывать async setup и асинхронные компоненты.",
  },
  {
    id: 337,
    category: "Vue",
    difficulty: "hard",
    question: "Для чего используется Teleport?",
    options: ["Чтобы отрендерить часть шаблона в другом месте DOM", "Чтобы перенести данные в localStorage", "Чтобы изменить props", "Чтобы создать store"],
    correctAnswerIndex: 0,
    explanation: "Teleport удобен для модалок, тултипов и оверлеев, которые логически принадлежат компоненту, но рендерятся вне него.",
  },
  {
    id: 338,
    category: "Vue",
    ...
    options: ["Кэширует динамические компоненты, сохраняя их состояние", "Отключает компонент", "Создает HTTP-подписку", "Удаляет route params"],
    correctAnswerIndex: 0,
    explanation: "keep-alive позволяет не пересоздавать компонент при переключении и сохраняет его локальное состояние.",
  },
  {
    id: 339,
    category: "Vue",
    ...
    options: ["watchEffect автоматически отслеживает зависимости внутри callback", "watchEffect работает только с props", "watchEffect не реактивен", "watchEffect нужен только для CSS"],
    correctAnswerIndex: 0,
    explanation: "watch требует явный источник, а watchEffect сам собирает зависимости во время выполнения.",
  },
  {
    id: 340,
    category: "Vue",
    difficulty: "hard",
    question: "Что означает hydration mismatch во Vue SSR?",
    options: ["Различие между серверной HTML-разметкой и клиентским рендером", "Ошибка CSS scoped", "Отсутствие key в v-for всегда", "Неверный import картинки"],
    correctAnswerIndex: 0,
    explanation: "Hydration mismatch возникает, когда клиентская разметка не совпадает с HTML, пришедшим с сервера.",
  },
  {
    id: 341,
    category: "Vue",
    difficulty: "easy",
    question: "Как во Vue вывести значение переменной в шаблоне?",
    options: ["Через двойные фигурные скобки {{ value }}", "Через квадратные скобки [value]", "Через тег <value>", "Через директиву v-print"],
    correctAnswerIndex: 0,
    explanation: "Интерполяция через {{ }} выводит текстовое значение реактивных данных в шаблоне.",
  },
  {
    id: 342,
    category: "Vue",
    difficulty: "easy",
    question: "Что делает директива v-show?",
    options: ["Переключает видимость через CSS display", "Удаляет компонент из проекта", "Создает новый prop", "Перезапускает приложение"],
    correctAnswerIndex: 0,
    explanation: "v-show не удаляет элемент из DOM, а меняет его отображение через display.",
  },
  {
    id: 343,
    category: "Vue",
    difficulty: "easy",
    question: "Чем v-show отличается от v-if?",
    options: ["v-show оставляет элемент в DOM, а v-if добавляет или удаляет его", "v-show работает только со списками", "v-if работает только с CSS", "Они полностью одинаковы"],
    correctAnswerIndex: 0,
    explanation: "v-if управляет существованием элемента, а v-show только его видимостью.",
  },
  {
    id: 344,
    category: "Vue",
    difficulty: "easy",
    question: "Какое сокращение используется для v-bind?",
    options: [":", "@", "#", "*"],
    correctAnswerIndex: 0,
    explanation: "Двоеточие является сокращением v-bind, например :class или :src.",
  },
  {
    id: 345,
    category: "Vue",
    difficulty: "easy",
    question: "Какое сокращение используется для v-on?",
    options: ["@", ":", "#", "~"],
    correctAnswerIndex: 0,
    explanation: "@click является сокращением записи v-on:click.",
  },
  {
    id: 346,
    category: "Vue",
    difficulty: "easy",
    question: "Что делает директива v-html?",
    options: ["Вставляет строку как HTML-разметку", "Экранирует весь HTML", "Создает HTML-файл", "Подключает внешний шаблон"],
    correctAnswerIndex: 0,
    explanation: "v-html вставляет HTML, но использовать его нужно осторожно из-за риска XSS.",
  },
  {
    id: 347,
    category: "Vue",
    difficulty: "easy",
    question: "Какой блок в .vue-файле отвечает за разметку?",
    options: ["<template>", "<script>", "<style>", "<config>"],
    correctAnswerIndex: 0,
    explanation: "В секции <template> описывается HTML-разметка компонента.",
  },
  {
    id: 348,
    category: "Vue",
    difficulty: "easy",
    question: "Какой блок в .vue-файле отвечает за логику компонента?",
    options: ["<script>", "<template>", "<style>", "<markup>"],
    correctAnswerIndex: 0,
    explanation: "В секции <script> находится JavaScript или TypeScript-логика компонента.",
  },
  {
    id: 349,
    category: "Vue",
    difficulty: "easy",
    question: "Какой блок в .vue-файле отвечает за стили?",
    options: ["<style>", "<script>", "<template>", "<css-module>"],
    correctAnswerIndex: 0,
    explanation: "Секция <style> содержит CSS для компонента.",
  },
  {
    id: 350,
    category: "Vue",
    difficulty: "easy",
    question: "Что делает метод app.mount('#app')?",
    options: ["Монтирует Vue-приложение в DOM-элемент", "Удаляет приложение", "Создает роут", "Подключает базу данных"],
    correctAnswerIndex: 0,
    explanation: "mount связывает Vue-приложение с конкретным элементом страницы.",
  },
  {
    id: 351,
    category: "Vue",
    difficulty: "easy",
    question: "Как во Vue передать prop строкой?",
    options: ["<UserCard name=\"Анна\" />", "<UserCard :name=\"Анна\" />", "<UserCard @name=\"Анна\" />", "<UserCard #name=\"Анна\" />"],
    correctAnswerIndex: 0,
    explanation: "Без двоеточия значение prop передается как обычная строка.",
  },
  {
    id: 352,
    category: "Vue",
    difficulty: "easy",
    question: "Как во Vue передать prop как выражение JavaScript?",
    options: ["Через :prop=\"expression\"", "Через @prop=\"expression\"", "Через *prop=\"expression\"", "Через prop={{ expression }}"],
    correctAnswerIndex: 0,
    explanation: "v-bind или его сокращение : позволяет передавать результат JavaScript-выражения.",
  },
  {
    id: 353,
    category: "Vue",
    ...
    options: ["Рендерит элемент один раз и больше не обновляет его", "Запускает событие один раз", "Создает один компонент", "Удаляет реактивность у всего приложения"],
    correctAnswerIndex: 0,
    explanation: "v-once полезен для статичного контента, который не должен обновляться.",
  },
  {
    id: 354,
    category: "Vue",
    difficulty: "easy",
    question: "Что делает v-pre?",
    options: ["Пропускает компиляцию элемента и его дочерних узлов", "Предзагружает компонент", "Создает preview", "Проверяет props"],
    correctAnswerIndex: 0,
    explanation: "v-pre оставляет содержимое как есть, например чтобы показать {{ }} как текст.",
  },
  {
    id: 355,
    category: "Vue",
    ...
    options: ["Переиспользуемая часть интерфейса со своей логикой и шаблоном", "Только CSS-класс", "Только HTML-атрибут", "Файл базы данных"],
    correctAnswerIndex: 0,
    explanation: "Компоненты позволяют делить интерфейс на самостоятельные и переиспользуемые блоки.",
  },
  {
    id: 356,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает модификатор .prevent у события?",
    options: ["Вызывает preventDefault для события", "Останавливает компиляцию", "Удаляет обработчик", "Запускает событие только один раз"],
    correctAnswerIndex: 0,
    explanation: "@submit.prevent позволяет отменить стандартное поведение формы прямо в шаблоне.",
  },
  {
    id: 357,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает модификатор .stop у события?",
    options: ["Останавливает всплытие события", "Останавливает приложение", "Запрещает рендер", "Очищает store"],
    correctAnswerIndex: 0,
    explanation: ".stop вызывает stopPropagation и не дает событию всплывать выше по DOM.",
  },
  {
    id: 358,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает модификатор .once у события?",
    options: ["Запускает обработчик только один раз", "Повторяет обработчик бесконечно", "Откладывает событие", "Создает watch"],
    correctAnswerIndex: 0,
    explanation: ".once регистрирует обработчик, который выполнится один раз.",
  },
  {
    id: 359,
    category: "Vue",
    difficulty: "medium",
    question: "Для чего нужен defineExpose в <script setup>?",
    options: ["Чтобы явно открыть свойства компонента родителю через template ref", "Чтобы объявить props", "Чтобы создать роут", "Чтобы подключить CSS"],
    correctAnswerIndex: 0,
    explanation: "defineExpose задает публичный интерфейс компонента при обращении через ref.",
  },
  {
    id: 360,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает nextTick?",
    options: ["Ждет завершения ближайшего обновления DOM", "Переключает маршрут", "Создает новый tick в store", "Очищает watchers"],
    correctAnswerIndex: 0,
    explanation: "nextTick используют, когда нужно дождаться, пока Vue применит изменения к DOM.",
  },
  {
    id: 361,
    category: "Vue",
    difficulty: "medium",
    question: "Что такое lifecycle hooks во Vue?",
    options: ["Функции, вызываемые на этапах жизни компонента", "CSS-хуки", "Маршруты приложения", "Типы props"],
    correctAnswerIndex: 0,
    explanation: "Например, onMounted, onUpdated и onUnmounted позволяют выполнять код в нужный момент жизни компонента.",
  },
  {
    id: 362,
    category: "Vue",
    difficulty: "medium",
    question: "Когда вызывается onMounted?",
    options: ["После монтирования компонента в DOM", "До создания приложения", "После удаления компонента", "При каждом клике"],
    correctAnswerIndex: 0,
    explanation: "onMounted подходит для кода, которому нужен уже созданный DOM.",
  },
  {
    id: 363,
    category: "Vue",
    difficulty: "medium",
    question: "Когда вызывается onUnmounted?",
    options: ["После удаления компонента из DOM", "Перед первым рендером", "При изменении любого prop", "При создании router"],
    correctAnswerIndex: 0,
    explanation: "onUnmounted часто используют для очистки таймеров, подписок и обработчиков.",
  },
  {
    id: 364,
    category: "Vue",
    ...
    options: ["Чтобы создать readonly-обертку над реактивным объектом", "Чтобы удалить объект", "Чтобы сделать CSS read-only", "Чтобы остановить роутер"],
    correctAnswerIndex: 0,
    explanation: "readonly защищает реактивные данные от изменений через полученную ссылку.",
  },
  {
    id: 365,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает toRefs?",
    options: ["Преобразует свойства reactive-объекта в refs", "Преобразует HTML в CSS", "Создает router refs", "Удаляет реактивность"],
    correctAnswerIndex: 0,
    explanation: "toRefs помогает деструктурировать reactive-объект без потери реактивности свойств.",
  },
  {
    id: 366,
    category: "Vue",
    difficulty: "medium",
    question: "Для чего используется toRef?",
    options: ["Чтобы создать ref, связанный с конкретным свойством объекта", "Чтобы склонировать компонент", "Чтобы создать ссылку <a>", "Чтобы прочитать route param"],
    correctAnswerIndex: 0,
    explanation: "toRef сохраняет связь с исходным свойством reactive-объекта.",
  },
  {
    id: 367,
    category: "Vue",
    difficulty: "medium",
    question: "Что такое named slots?",
    options: ["Слоты с именами для передачи контента в разные области компонента", "Слоты только для роутера", "Имена CSS-классов", "Список props"],
    correctAnswerIndex: 0,
    explanation: "Именованные слоты позволяют компоненту иметь несколько точек вставки контента.",
  },
  {
    id: 368,
    category: "Vue",
    ...
    options: ["Слоты, которым дочерний компонент передает данные наружу", "CSS scoped стили", "Слоты только для модалок", "Слоты без template"],
    correctAnswerIndex: 0,
    explanation: "Scoped slots дают родителю доступ к данным, подготовленным дочерним компонентом.",
  },
  {
    id: 369,
    category: "Vue",
    ...
    options: ["Создает ссылку для навигации через Vue Router", "Создает HTTP-запрос", "Создает store", "Подключает CSS"],
    correctAnswerIndex: 0,
    explanation: "RouterLink навигирует внутри SPA без полной перезагрузки страницы.",
  },
  {
    id: 370,
    category: "Vue",
    ...
    options: ["Показывает компонент активного маршрута", "Показывает список всех роутов", "Создает ссылку", "Хранит состояние"],
    correctAnswerIndex: 0,
    explanation: "RouterView является местом, куда Vue Router рендерит совпавший компонент.",
  },
  {
    id: 371,
    category: "Vue",
    difficulty: "medium",
    question: "Что такое dynamic component во Vue?",
    options: ["Компонент, выбранный динамически через <component :is=\"...\">", "Компонент без props", "Компонент только для SSR", "Компонент с одним style"],
    correctAnswerIndex: 0,
    explanation: "<component :is> позволяет переключать компонент по состоянию.",
  },
  {
    id: 372,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает Transition?",
    options: ["Добавляет классы для анимации входа и выхода элемента", "Создает роут", "Кэширует компонент", "Останавливает watcher"],
    correctAnswerIndex: 0,
    explanation: "Transition помогает анимировать появление и исчезновение элементов или компонентов.",
  },
  {
    id: 373,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает TransitionGroup?",
    options: ["Анимирует изменения списка элементов", "Группирует props", "Создает store-модуль", "Запускает SSR"],
    correctAnswerIndex: 0,
    explanation: "TransitionGroup используется для анимации добавления, удаления и перемещения элементов списка.",
  },
  {
    id: 374,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает модификатор v-model .trim?",
    options: ["Удаляет пробелы в начале и конце введенного значения", "Обрезает компонент", "Удаляет prop", "Сжимает bundle"],
    correctAnswerIndex: 0,
    explanation: "v-model.trim автоматически применяет trim к строке из поля ввода.",
  },
  {
    id: 375,
    category: "Vue",
    difficulty: "medium",
    question: "Что делает модификатор v-model .number?",
    options: ["Пытается привести введенное значение к числу", "Добавляет номер вопроса", "Считает клики", "Создает numeric route"],
    correctAnswerIndex: 0,
    explanation: "v-model.number полезен для числовых input, когда нужно получить number вместо string.",
  },
  {
    id: 376,
    category: "Vue",
    difficulty: "hard",
    question: "Что такое custom directive во Vue?",
    options: ["Пользовательская директива для прямой работы с DOM-элементом", "Пользовательский роут", "Пользовательский prop", "Тип store"],
    correctAnswerIndex: 0,
    explanation: "Custom directives подходят для низкоуровневого поведения DOM, например focus или observer.",
  },
  {
    id: 377,
    category: "Vue",
    difficulty: "hard",
    question: "Для чего используется effectScope?",
    options: ["Для группировки реактивных эффектов и их общей остановки", "Для создания CSS scope", "Для настройки router base", "Для передачи slot props"],
    correctAnswerIndex: 0,
    explanation: "effectScope помогает управлять временем жизни watchers и computed-эффектов.",
  },
  {
    id: 378,
    category: "Vue",
    difficulty: "hard",
    question: "Что делает markRaw?",
    options: ["Исключает объект из системы реактивности Vue", "Помечает HTML как небезопасный", "Создает raw CSS", "Удаляет компонент"],
    correctAnswerIndex: 0,
    explanation: "markRaw полезен для внешних классовых инстансов или больших объектов, которые не нужно делать реактивными.",
  },
  {
    id: 379,
    category: "Vue",
    difficulty: "hard",
    question: "Когда полезен customRef?",
    options: ["Когда нужно вручную контролировать track и trigger у ref", "Когда нужен обычный prop", "Когда нужно создать CSS variable", "Когда нужно отключить router"],
    correctAnswerIndex: 0,
    explanation: "customRef позволяет, например, сделать debounce для реактивного значения.",
  },
  {
    id: 380,
    category: "Vue",
    ...
    options: ["Принудительно уведомляет зависимости shallowRef об изменении", "Запускает click", "Создает новый ref", "Удаляет watcher"],
    correctAnswerIndex: 0,
    explanation: "triggerRef нужен, когда внутри shallowRef изменился вложенный объект, но .value остался тем же.",
  },
  {
    id: 381,
    category: "Vue",
    difficulty: "hard",
    question: "Что такое async component во Vue?",
    options: ["Компонент, загружаемый асинхронно через defineAsyncComponent", "Компонент только с async method", "Компонент без template", "Компонент для формы"],
    correctAnswerIndex: 0,
    explanation: "Асинхронные компоненты помогают делить bundle и загружать код по необходимости.",
  },
  {
    id: 382,
    category: "Vue",
    difficulty: "hard",
    question: "Что делает defineAsyncComponent?",
    options: ["Объявляет компонент, который будет загружен лениво", "Объявляет async prop", "Создает Promise-store", "Запускает SSR"],
    correctAnswerIndex: 0,
    explanation: "defineAsyncComponent принимает loader и возвращает компонент, который Vue загрузит при рендере.",
  },
  {
    id: 383,
    category: "Vue",
    difficulty: "hard",
    question: "Что такое navigation guard во Vue Router?",
    options: ["Хук, который может разрешить, отменить или перенаправить навигацию", "CSS-защита", "Тип slot", "Метод Pinia"],
    correctAnswerIndex: 0,
    explanation: "Guards позволяют проверять авторизацию, права доступа или несохраненные изменения перед переходом.",
  },
  {
    id: 384,
    category: "Vue",
    difficulty: "hard",
    question: "Для чего используется beforeRouteLeave?",
    options: ["Чтобы обработать уход пользователя с текущего маршрута", "Чтобы создать новый route", "Чтобы загрузить CSS", "Чтобы удалить store"],
    correctAnswerIndex: 0,
    explanation: "beforeRouteLeave часто применяют для предупреждения о несохраненных изменениях.",
  },
  {
    id: 385,
    category: "Vue",
    difficulty: "hard",
    question: "Что такое store getter в Pinia?",
    options: ["Вычисляемое значение на основе состояния store", "HTTP-запрос", "Маршрут", "CSS-переменная"],
    correctAnswerIndex: 0,
    explanation: "Getters в Pinia похожи на computed и позволяют получать производные данные из state.",
  },
  {
    id: 386,
    category: "Vue",
    difficulty: "hard",
    question: "Что такое action в Pinia?",
    options: ["Метод store для изменения состояния и выполнения логики", "CSS-анимация", "Название route", "Тип слота"],
    correctAnswerIndex: 0,
    explanation: "Actions содержат бизнес-логику store и могут быть асинхронными.",
  },
  {
    id: 387,
    category: "Vue",
    difficulty: "hard",
    question: "Что делает storeToRefs в Pinia?",
    options: ["Преобразует state и getters store в refs без потери реактивности", "Удаляет store", "Создает router refs", "Копирует CSS"],
    correctAnswerIndex: 0,
    explanation: "storeToRefs удобен при деструктуризации store в setup.",
  },
  {
    id: 388,
    category: "Vue",
    difficulty: "hard",
    question: "Почему мутировать prop напрямую во Vue плохая практика?",
    options: ["Потому что источник данных должен оставаться у родителя", "Потому что prop всегда readonly в CSS", "Потому что это отключает router", "Потому что это удаляет компонент"],
    correctAnswerIndex: 0,
    explanation: "Дочерний компонент должен отправлять событие родителю, а родитель уже обновляет свои данные.",
  },
  {
    id: 389,
    category: "Vue",
    difficulty: "hard",
    question: "Что такое render function во Vue?",
    options: ["Функция, которая программно описывает виртуальные узлы компонента", "Функция для CSS", "Метод router", "Тип HTTP-запроса"],
    correctAnswerIndex: 0,
    explanation: "Render functions полезны для сложной динамической разметки и библиотечных компонентов.",
  },
  {
    id: 390,
    category: "Vue",
    difficulty: "hard",
    question: "Для чего используется h() во Vue?",
    options: ["Для создания виртуального DOM-узла в render function", "Для объявления заголовка HTML", "Для запуска hydration", "Для создания helper route"],
    correctAnswerIndex: 0,
    explanation: "h() создает VNode и часто используется внутри render functions.",
  },
  {
    id: 391,
    category: "Angular",
    difficulty: "easy",
    question: "Что такое selector в Angular-компоненте?",
    options: ["Имя HTML-тега или селектора, через который компонент используется", "Название CSS-файла", "Тип сервиса", "Адрес API"],
    correctAnswerIndex: 0,
    explanation: "selector указывает, как компонент будет вставляться в шаблон другого компонента.",
  },
  {
    id: 392,
    category: "Angular",
    difficulty: "easy",
    question: "Что означает templateUrl в @Component?",
    options: ["Путь к HTML-шаблону компонента", "Путь к API", "Путь к роуту", "Путь к package.json"],
    correctAnswerIndex: 0,
    explanation: "templateUrl подключает внешний HTML-файл как шаблон компонента.",
  },
  {
    id: 393,
    category: "Angular",
    difficulty: "easy",
    question: "Что означает styleUrls в @Component?",
    options: ["Список файлов стилей компонента", "Список маршрутов", "Список сервисов", "Список HTTP-запросов"],
    correctAnswerIndex: 0,
    explanation: "styleUrls подключает CSS/SCSS-файлы, относящиеся к компоненту.",
  },
  {
    id: 394,
    category: "Angular",
    difficulty: "easy",
    question: "Какой файл обычно является точкой входа Angular-приложения?",
    options: ["main.ts", "index.css", "routes.json", "database.ts"],
    correctAnswerIndex: 0,
    explanation: "main.ts запускает приложение и обычно вызывает bootstrapApplication или bootstrapModule.",
  },
  {
    id: 395,
    category: "Angular",
    difficulty: "easy",
    question: "Что делает интерполяция {{ value }} в Angular?",
    options: ["Выводит значение из компонента в шаблон", "Создает цикл", "Подключает сервис", "Меняет роут"],
    correctAnswerIndex: 0,
    explanation: "Интерполяция отображает данные компонента как текст в шаблоне.",
  },
  {
    id: 396,
    category: "Angular",
    difficulty: "easy",
    question: "Что такое template reference variable, например #input?",
    options: ["Локальная ссылка на элемент или директиву в шаблоне", "CSS-переменная", "Глобальный сервис", "Переменная окружения"],
    correctAnswerIndex: 0,
    explanation: "Переменная с # позволяет обратиться к элементу или директиве внутри шаблона.",
  },
  {
    id: 397,
    category: "Angular",
    difficulty: "easy",
    question: "Для чего используется ngModel?",
    options: ["Для двусторонней привязки значения формы", "Для создания роутов", "Для подключения CSS", "Для сборки проекта"],
    correctAnswerIndex: 0,
    explanation: "ngModel связывает значение поля формы со свойством компонента.",
  },
  {
    id: 398,
    category: "Angular",
    difficulty: "easy",
    question: "Как записывается двусторонняя привязка в Angular?",
    options: ["[(ngModel)]", "[ngModel]", "(ngModel)", "{{ ngModel }}"],
    correctAnswerIndex: 0,
    explanation: "Синтаксис [(...)] часто называют banana in a box: property binding плюс event binding.",
  },
  {
    id: 399,
    category: "Angular",
    difficulty: "easy",
    question: "Что делает [disabled]=\"isDisabled\"?",
    options: ["Привязывает свойство disabled к значению isDisabled", "Создает событие disabled", "Удаляет кнопку", "Создает CSS-класс"],
    correctAnswerIndex: 0,
    explanation: "Квадратные скобки связывают DOM-свойство с выражением компонента.",
  },
  {
    id: 400,
    category: "Angular",
    difficulty: "easy",
    question: "Что делает (submit)=\"save()\"?",
    options: ["Вызывает метод save при событии submit", "Создает форму", "Подключает валидатор", "Меняет URL"],
    correctAnswerIndex: 0,
    explanation: "Круглые скобки подписывают шаблон на событие элемента.",
  },
  {
    id: 401,
    category: "Angular",
    difficulty: "easy",
    question: "Для чего нужен ngStyle?",
    options: ["Для динамического задания inline-стилей", "Для создания сервиса", "Для загрузки данных", "Для объявления модуля"],
    correctAnswerIndex: 0,
    explanation: "ngStyle применяет стили на основе объекта или выражения.",
  },
  {
    id: 402,
    category: "Angular",
    difficulty: "easy",
    question: "Что такое AppComponent?",
    options: ["Обычно корневой компонент приложения", "Встроенный CSS-файл", "Сервис роутера", "Команда CLI"],
    correctAnswerIndex: 0,
    explanation: "AppComponent часто служит верхним компонентом, внутри которого рендерится остальное приложение.",
  },
  {
    id: 403,
    category: "Angular",
    difficulty: "easy",
    question: "Что делает router-outlet?",
    options: ["Показывает компонент активного маршрута", "Создает ссылку", "Выполняет HTTP-запрос", "Запускает тесты"],
    correctAnswerIndex: 0,
    explanation: "router-outlet является местом, куда Angular Router вставляет компонент выбранного маршрута.",
  },
  {
    id: 404,
    category: "Angular",
    difficulty: "easy",
    question: "Что делает routerLink?",
    options: ["Создает ссылку для навигации через Angular Router", "Создает HTTP-клиент", "Подключает форму", "Компилирует шаблон"],
    correctAnswerIndex: 0,
    explanation: "routerLink позволяет переходить между маршрутами без полной перезагрузки страницы.",
  },
  {
    id: 405,
    category: "Angular",
    difficulty: "easy",
    question: "Что такое Pipe date?",
    options: ["Встроенный pipe для форматирования дат", "Сервис для роутинга", "Директива для списков", "Метод HTTP"],
    correctAnswerIndex: 0,
    explanation: "DatePipe форматирует даты прямо в шаблоне.",
  },
  {
    id: 406,
    category: "Angular",
    difficulty: "medium",
    question: "Что такое lifecycle hooks в Angular?",
    options: ["Методы, вызываемые на этапах жизни компонента", "CSS-события", "Только роуты", "Типы форм"],
    correctAnswerIndex: 0,
    explanation: "ngOnInit, ngOnDestroy и другие хуки позволяют выполнять код в нужный момент жизни компонента.",
  },
  {
    id: 407,
    category: "Angular",
    difficulty: "medium",
    question: "Когда вызывается ngOnInit?",
    options: ["После инициализации входных свойств компонента", "После удаления компонента", "При каждом клике", "До создания класса"],
    correctAnswerIndex: 0,
    explanation: "ngOnInit часто используют для начальной загрузки данных и настройки компонента.",
  },
  {
    id: 408,
    category: "Angular",
    difficulty: "medium",
    question: "Для чего используется ngOnDestroy?",
    options: ["Для очистки ресурсов перед уничтожением компонента", "Для создания компонента", "Для форматирования дат", "Для смены selector"],
    correctAnswerIndex: 0,
    explanation: "В ngOnDestroy обычно очищают подписки, таймеры и внешние обработчики.",
  },
  {
    id: 409,
    category: "Angular",
    difficulty: "medium",
    question: "Что такое ActivatedRoute?",
    options: ["Сервис с данными текущего активного маршрута", "CSS-директива", "Форма", "Pipe"],
    correctAnswerIndex: 0,
    explanation: "ActivatedRoute дает доступ к params, queryParams, data и другим данным текущего маршрута.",
  },
  {
    id: 410,
    category: "Angular",
    difficulty: "medium",
    question: "Как получить параметр маршрута в Angular?",
    options: ["Через ActivatedRoute params или paramMap", "Через localStorage всегда", "Через CSS-класс", "Через templateUrl"],
    correctAnswerIndex: 0,
    explanation: "Параметры маршрута читают из ActivatedRoute, например route.paramMap.",
  },
  {
    id: 411,
    category: "Angular",
    ...
    options: ["Группа FormControl в reactive forms", "Группа компонентов", "Группа маршрутов", "Группа CSS-файлов"],
    correctAnswerIndex: 0,
    explanation: "FormGroup объединяет несколько контролов формы в одно состояние.",
  },
  {
    id: 412,
    category: "Angular",
    ...
    options: ["Объект состояния одного поля формы", "Компонент кнопки", "Роут", "Pipe"],
    correctAnswerIndex: 0,
    explanation: "FormControl хранит значение, валидность и состояние конкретного поля.",
  },
  {
    id: 413,
    category: "Angular",
    difficulty: "medium",
    question: "Для чего нужны Validators?",
    options: ["Для проверки значений формы", "Для сборки проекта", "Для создания сервиса", "Для подключения SVG"],
    correctAnswerIndex: 0,
    explanation: "Validators.required, Validators.email и другие валидаторы проверяют поля формы.",
  },
  {
    id: 414,
    category: "Angular",
    difficulty: "medium",
    question: "Что такое custom validator?",
    options: ["Пользовательская функция проверки значения формы", "Пользовательский роут", "CSS-фильтр", "Новый тип компонента"],
    correctAnswerIndex: 0,
    explanation: "Custom validator возвращает объект ошибки или null, если значение валидно.",
  },
  {
    id: 415,
    category: "Angular",
    ...
    options: ["Перехватывает HTTP-запросы и ответы", "Перехватывает клики мыши", "Создает компонент", "Останавливает change detection"],
    correctAnswerIndex: 0,
    explanation: "Interceptors используют для токенов авторизации, логирования, обработки ошибок и других сквозных задач.",
  },
  {
    id: 416,
    category: "Angular",
    ...
    options: ["Механизм передачи зависимостей классу извне", "Синтаксис CSS", "Тип роутинга", "Метод массива"],
    correctAnswerIndex: 0,
    explanation: "DI позволяет Angular создавать и передавать сервисы компонентам и другим сервисам.",
  },
  {
    id: 417,
    category: "Angular",
    difficulty: "medium",
    question: "Что такое provider в Angular?",
    options: ["Настройка, которая говорит injector, как создать зависимость", "HTML-тег", "CSS-правило", "Параметр маршрута"],
    correctAnswerIndex: 0,
    explanation: "Provider регистрирует сервис или значение в системе dependency injection.",
  },
  {
    id: 418,
    category: "Angular",
    ...
    options: ["Механизм группировки компонентов, директив, pipes и сервисов", "Один HTML-шаблон", "Встроенный валидатор", "Файл package-lock"],
    correctAnswerIndex: 0,
    explanation: "NgModule был классическим способом организации Angular-приложений до широкого применения standalone API.",
  },
  {
    id: 419,
    category: "Angular",
    difficulty: "medium",
    question: "Что делает declarations в NgModule?",
    options: ["Объявляет компоненты, директивы и pipes модуля", "Подключает API", "Запускает сервер", "Создает styles"],
    correctAnswerIndex: 0,
    explanation: "В declarations регистрируют сущности, которые принадлежат этому модулю.",
  },
  {
    id: 420,
    category: "Angular",
    difficulty: "medium",
    question: "Что делает imports в NgModule?",
    options: ["Подключает другие модули, нужные текущему", "Импортирует картинки в DOM", "Создает HTTP-запрос", "Очищает форму"],
    correctAnswerIndex: 0,
    explanation: "imports делает функциональность других модулей доступной внутри текущего модуля.",
  },
  {
    id: 421,
    category: "Angular",
    difficulty: "medium",
    question: "Что делает exports в NgModule?",
    options: ["Делает объявления модуля доступными другим модулям", "Экспортирует базу данных", "Открывает devtools", "Удаляет компонент"],
    correctAnswerIndex: 0,
    explanation: "exports позволяет другим модулям использовать компоненты, директивы или pipes текущего модуля.",
  },
  {
    id: 422,
    category: "Angular",
    difficulty: "medium",
    question: "Для чего нужен ViewChild?",
    options: ["Для доступа к дочернему компоненту, директиве или DOM-элементу", "Для создания маршрута", "Для валидации email", "Для объявления сервиса"],
    correctAnswerIndex: 0,
    explanation: "ViewChild позволяет получить ссылку на элемент или дочернюю сущность из шаблона компонента.",
  },
  {
    id: 423,
    category: "Angular",
    difficulty: "medium",
    question: "Для чего нужен ContentChild?",
    options: ["Для доступа к контенту, переданному через ng-content", "Для чтения URL", "Для запуска сборки", "Для создания pipe"],
    correctAnswerIndex: 0,
    explanation: "ContentChild работает с проецируемым содержимым, а не с собственным view компонента.",
  },
  {
    id: 424,
    category: "Angular",
    difficulty: "medium",
    question: "Что такое content projection?",
    options: ["Передача внешней разметки внутрь компонента через ng-content", "Оптимизация bundle", "Стилизация формы", "Создание HTTP interceptor"],
    correctAnswerIndex: 0,
    explanation: "ng-content позволяет компоненту принимать и отображать контент от родителя.",
  },
  {
    id: 425,
    category: "Angular",
    difficulty: "medium",
    question: "Что делает pipe async с Observable?",
    options: ["Подписывается, выводит последнее значение и отписывается автоматически", "Преобразует Observable в CSS", "Запускает роутер", "Делает Observable синхронным"],
    correctAnswerIndex: 0,
    explanation: "async pipe управляет подпиской в шаблоне и снижает риск утечек памяти.",
  },
  {
    id: 426,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое InjectionToken?",
    options: ["Токен для внедрения значений или интерфейсоподобных зависимостей", "JWT-токен всегда", "CSS-переменная", "Параметр маршрута"],
    correctAnswerIndex: 0,
    explanation: "InjectionToken используют, когда нельзя опереться на класс как DI-токен.",
  },
  {
    id: 427,
    category: "Angular",
    difficulty: "hard",
    question: "Что делает useFactory в provider?",
    options: ["Создает зависимость через фабричную функцию", "Создает CSS-фабрику", "Удаляет сервис", "Создает router guard"],
    correctAnswerIndex: 0,
    explanation: "useFactory полезен, когда создание зависимости зависит от условий или других сервисов.",
  },
  {
    id: 428,
    category: "Angular",
    difficulty: "hard",
    question: "Что делает useExisting в provider?",
    options: ["Создает alias на уже существующий provider", "Создает новый инстанс всегда", "Удаляет provider", "Подключает template"],
    correctAnswerIndex: 0,
    explanation: "useExisting позволяет одному токену ссылаться на зависимость, зарегистрированную под другим токеном.",
  },
  {
    id: 429,
    category: "Angular",
    difficulty: "hard",
    question: "Что означает multi: true у provider?",
    options: ["Позволяет собрать несколько provider под одним токеном", "Создает много компонентов", "Запускает много роутов", "Дублирует CSS"],
    correctAnswerIndex: 0,
    explanation: "multi providers используются, например, для HTTP_INTERCEPTORS.",
  },
  {
    id: 430,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое ControlValueAccessor?",
    options: ["Интерфейс для интеграции кастомного контрола с Angular Forms", "HTTP-интерцептор", "Router resolver", "Pipe для чисел"],
    correctAnswerIndex: 0,
    explanation: "ControlValueAccessor позволяет пользовательскому компоненту работать с ngModel или reactive forms.",
  },
  {
    id: 431,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое APP_INITIALIZER?",
    options: ["Токен для запуска логики перед стартом приложения", "Компонент загрузчика", "CSS-класс", "Guard для выхода"],
    correctAnswerIndex: 0,
    explanation: "APP_INITIALIZER используют для предварительной загрузки конфигурации или важных данных.",
  },
  {
    id: 432,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое CanDeactivate guard?",
    options: ["Guard, который решает, можно ли уйти с текущего маршрута", "Guard для CSS", "Pipe для дат", "Валидатор формы"],
    correctAnswerIndex: 0,
    explanation: "CanDeactivate часто применяют для защиты от потери несохраненных изменений.",
  },
  {
    id: 433,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое preloadingStrategy в Router?",
    options: ["Стратегия фоновой загрузки lazy routes", "Стратегия валидации", "CSS-анимация", "Метод HttpClient"],
    correctAnswerIndex: 0,
    explanation: "PreloadingStrategy позволяет загружать ленивые маршруты после начального старта приложения.",
  },
  {
    id: 434,
    category: "Angular",
    difficulty: "hard",
    question: "Что делает ChangeDetectorRef.markForCheck()?",
    options: ["Помечает OnPush-компонент для проверки при следующем цикле", "Удаляет компонент", "Создает новый detector", "Останавливает Router"],
    correctAnswerIndex: 0,
    explanation: "markForCheck сообщает Angular, что компонент нужно проверить даже при OnPush.",
  },
  {
    id: 435,
    category: "Angular",
    difficulty: "hard",
    question: "Что делает ChangeDetectorRef.detectChanges()?",
    options: ["Запускает проверку изменений для компонента и его дочерних view", "Отключает DI", "Создает Observable", "Удаляет DOM"],
    correctAnswerIndex: 0,
    explanation: "detectChanges вручную запускает change detection для конкретной ветки view.",
  },
  {
    id: 436,
    category: "Angular",
    difficulty: "hard",
    question: "Что делает runOutsideAngular?",
    options: ["Выполняет код вне Angular zone, чтобы не запускать лишний change detection", "Удаляет Angular", "Запускает код только на сервере", "Отключает TypeScript"],
    correctAnswerIndex: 0,
    explanation: "runOutsideAngular полезен для частых событий, анимаций или сторонних библиотек.",
  },
  {
    id: 437,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое host binding?",
    options: ["Привязка свойства или класса к host-элементу директивы/компонента", "Привязка к серверу", "Маршрут хоста", "HTTP-заголовок"],
    correctAnswerIndex: 0,
    explanation: "HostBinding позволяет управлять атрибутами, классами или стилями host-элемента.",
  },
  {
    id: 438,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое host listener?",
    options: ["Подписка директивы или компонента на событие host-элемента", "Слушатель сервера", "Pipe для событий", "HTTP interceptor"],
    correctAnswerIndex: 0,
    explanation: "HostListener позволяет реагировать на события host-элемента или глобальных объектов.",
  },
  {
    id: 439,
    category: "Angular",
    difficulty: "hard",
    question: "Что такое structural directive?",
    options: ["Директива, изменяющая структуру DOM", "Директива только для CSS", "Сервис DI", "Тип валидатора"],
    correctAnswerIndex: 0,
    explanation: "*ngIf и *ngFor являются структурными директивами, потому что добавляют или удаляют фрагменты DOM.",
  },
  {
    id: 440,
    category: "Angular",
    ...
    options: ["Подключение Angular к HTML, уже отрендеренному на сервере", "Очистка формы", "Загрузка CSS-файлов", "Создание нового NgModule"],
    correctAnswerIndex: 0,
    explanation: "Hydration позволяет переиспользовать серверную разметку и сделать ее интерактивной на клиенте.",
  },
];

const shuffledData = rawData.map((item) => {
  ...
  return {
    ...
    correctAnswerIndex: options.findIndex(({ isCorrect }) => isCorrect),
  };
});
...
export const arrStack = [
  ...
  { id: 5, technology: "Angular", color: "#DD0031", icon: Angular },
  { id: 6, technology: "Vue", color: "#4FC08D", icon: Vue },
];
